//! PosixPath - POSIX-specific concrete path.
...
impl PosixPath {
    ...
    fn cwd() -> PyResult<Self> {
        ...
        Ok(Self {
            inner: PurePath {
                parsed: ParsedPath::parse(&cwd.to_string_lossy(), PathFlavor::Posix),
    ...
    fn home() -> PyResult<Self> {
        ...
        Ok(Self {
            inner: PurePath {
                parsed: ParsedPath::parse(&home.to_string_lossy(), PathFlavor::Posix),
                flavor: PathFlavor::Posix,
            },
        })
    }
    ...
    fn __repr__(&self) -> String {
        format!("PosixPath('{}')", self.inner.to_str())
    }
